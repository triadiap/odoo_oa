...
class ExcavaMiniRejectionWizard(models.TransientModel):
    _name = 'excavamini.rejection.wizard'
    _description = 'Excavamini Report Rejection Wizard'
    ...
    def default_get(self, fields):
        res = super(ExcavaMiniRejectionWizard, self).default_get(fields)
