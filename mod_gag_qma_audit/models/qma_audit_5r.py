...
class QmaFormAudit(models.Model):
    ...
    ringkas_1 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="1. Makanan ", required=True)
    note_ringkas_1 = fields.Char(string="Catatan")

    ringkas_2 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="2. Komponen / Bahan ", required=True)
    note_ringkas_2 = fields.Char(string="Catatan")

    ringkas_3 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="3. Peralatan Kerja ", required=True)
    note_ringkas_3 = fields.Char(string="Catatan")

    ringkas_4 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="4. Dokumen ", required=True)
    note_ringkas_4 = fields.Char(string="Catatan")

    ringkas_5 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="5. Pengendalian Visual ", required=True)
    ...
    rapi_1 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="6. Meja Kerja ", required=True)
    note_rapi_1 = fields.Char(string="Catatan")

    rapi_2 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="7. Alat Tulis Kantor (ATK) ", required=True)
    note_rapi_2 = fields.Char(string="Catatan")

    rapi_3 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="8. Peralatan ", required=True)
    note_rapi_3 = fields.Char(string="Catatan")

    rapi_4 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="9. Kursi ", required=True)
    note_rapi_4 = fields.Char(string="Catatan")

    rapi_5 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="10. P3K ", required=True)
    ...
    resik_1 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="11. Lantai ", required=True)
    note_resik_1 = fields.Char(string="Catatan")

    resik_2 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="12. Printer / Peralatan Kerja ", required=True)
    note_resik_2 = fields.Char(string="Catatan")

    resik_3 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="13. Tempat Sampah ", required=True)
    note_resik_3 = fields.Char(string="Catatan")

    resik_4 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="14. Peralatan Kebersihan ", required=True)
    note_resik_4 = fields.Char(string="Catatan")

    resik_5 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="15. Kebersihan ", required=True)
    ...
    rawat_1 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="16. Peralatan Kerja ", required=True)
    note_rawat_1 = fields.Char(string="Catatan")

    rawat_2 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="17. Berpakaian ", required=True)
    note_rawat_2 = fields.Char(string="Catatan")

    rawat_3 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="18. Kondisi Lingkungan ", required=True)
    note_rawat_3 = fields.Char(string="Catatan")

    rawat_4 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="19. Pengumuman Tertulis ", required=True)
    note_rawat_4 = fields.Char(string="Catatan")

    rawat_5 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="20. AC, Lampu, APAR ", required=True)
    ...
    rajin_1 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="21. Peraturan Perusahaan ", required=True)
    note_rajin_1 = fields.Char(string="Catatan")

    rajin_2 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="22. Absensi ", required=True)
    note_rajin_2 = fields.Char(string="Catatan")

    rajin_3 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="23. Hub. Antar Pekerja ", required=True)
    note_rajin_3 = fields.Char(string="Catatan")

    rajin_4 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="24. Jobdesk ", required=True)
    note_rajin_4 = fields.Char(string="Catatan")

    rajin_5 = fields.Selection([
        ("0", "0"),
        ("1", "1"),
        ("2", "2"),
        ("3", "3"),
        ("4", "4"),
    ], string="25. SOP ", required=True)
