...
class MoCutiRoster(models.Model):
    _name = "mo.cuti.roster"
    ...
    approval_3 = fields.Many2one("res.users", string="HC Dept")

    state = fields.Selection([
        ("draft", "Draft"),
        ("approval_1", "Approved By Spv / Atasan"),
        ("approval_2", "Approved By Manager Divisi"),
        ("approval_3", "Approved By HC Dept"),
        ("rejected", "Rejected")
    ...
    def create(self, vals):
        ...
        return super(MoCutiRoster, self).create(vals)
    ...
    def action_approval_1(self):
        for record in self:
            ...
            if next_step:
                ...
                records = self.env['mo.cuti.roster'].browse(self.id)
                records.write(vals)
